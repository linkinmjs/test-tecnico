...
// RUTAS DE INDIVIDUOS 
//TO-DO: completar el resto de las rutas
Route::get('/guy', 'GuyController@index')->name('guy_index_path');
Route::group([
    'prefix' => 'guy'
], function() {
    Route::post('search', 'GuyController@search')->name('guy_search_path');
    Route::get('create', 'GuyController@create')->name('guy_create_path');
    // Route::get('show/{id}', 'CategoryController@show')->name('category_show_path');
    Route::get('edit/{id}', 'GuyController@edit')->name('guy_edit_path');
    Route::get('destroy/{id}', 'GuyController@destroy')->name('guy_destroy_path');
    // Route::post('update', 'GuyController@update')->name('guy_update_path');
    Route::post('store', 'GuyController@store')->name('guy_store_path');
    // Route::get('update_status/{id}', 'CategoryController@updateStatus')->name('category_update_status_path');
});